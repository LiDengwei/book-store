...
<head>
  ...
  <script type="text/javascript">
    var grid = null;
    var CustomersData =
    {Rows:${result.authList},Total:${result.auth.totalRows}};
    $(function () {

      grid = $("#maingrid4").ligerGrid({
        columns: [
          { display: '权限名称', name: 'authorityName' },
          { display: '权限描述', name: 'authorityDesc' },
          ...
          { display: '是否是超级用户', name: 'isSys',render:function(rowData){
            if(rowData.isSys=='0'){
              return '否';
        ...
        ],  pageSize:${result.auth.pageSize},where : f_getWhere(),
        data: CustomersData,
...
//                  });
    ...
    function f_getWhere()
    {
      ...
      var clause = function (rowdata, rowindex)
      {
        ...
        return rowdata.authorityName.indexOf(authorityName) > -1;
      };
      return clause;
    }
  </script>
...
<div id="searchbar" style="margin-bottom: 10px;">
  权限名称：<input id="authorityName" type="text" />
